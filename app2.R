...
library(dplyr)
library(tidyr)
library(ggplot2) # Not directly used in map output
library(lubridate)
library(stringr)
library(knitr) # Not directly used in map output
library(sf)
library(leaflet)
library(htmltools)
library(htmlwidgets)
library(councildown)
library(councilverse) # Not used for interactive display
library(glue)

# --- 1. Initial Data Loading and Basic Prep (Run Once) ---

# IMPORTANT: Path to your data file
emergency_data_file <- "~/Documents/Emergency_Notifs_for_CED/data/output/emergency_data_cleaned.xlsx" 
